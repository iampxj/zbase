...
#ifndef BASEWORK_KFIFO_H_
#define BASEWORK_KFIFO_H_
...
(void)({ \
	...
	__kfifo->in = 0; \
	__kfifo->out = 0; \
	__kfifo->mask = __is_kfifo_ptr(__tmp) ? 0 : rte_array_size(__tmp->buf) - 1;\
