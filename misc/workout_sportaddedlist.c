...
static const uint8_t default_sports[] = {
    K_SPORT_OUTDOOR_RUNNING,
    K_SPORT_OUTDOOR_WALKING,
    K_SPORT_AUSTRALIAN_RULES_FOOTBALL,
    K_SPORT_OUTDOOR_CYCLING,
    K_SPORT_AEROBIC_FITNESS,
    K_SPORT_POOL_SWIMMING,
    K_SPORT_INDOOR_RUNNING,
    K_SPORT_HIIT,
    K_SPORT_BARBELL,
    K_SPORT_KICKBOXING,
    K_SPORT_INDOOR_CYCLING,
    K_SPORT_INDOOR_WALKING,
    K_SPORT_YOGA,
    K_SPORT_ELLIPTICAL,
    K_SPORT_HIKING,
    K_SPORT_PADEL,
