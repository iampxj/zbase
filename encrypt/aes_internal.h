...
typedef struct AVAES {
    ...
    // DECLARE_ALIGNED(16, aes_block_t, round_key)[15];
    // DECLARE_ALIGNED(16, aes_block_t, state)[2];
    aes_block_t round_key[15] __rte_aligned(16);
    aes_block_t state[2] __rte_aligned(16);
    int rounds;
